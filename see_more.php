...
<div class="row">
 <div class="col-md-10">
  ...
  <div class="row m-auto">
        ...
        <!-------one item product image card---------
        <div class="col-md-4">
    <div class='card'>
     <img src='image/mango.jpg' class='card-img-top' alt='$product_title'>
    <div class='card-body'>
    ...
    <div class="col-md-8">
        <-----related item product of above image card---------
        <div class="row">
            <div class="col-md-12">
                <h3 class="text-center text-info mb-5 mt-4">Related product</h3>
            </div>
            <div class="col-md-6">
            <img src='image/mango1.jpg' class='card-img-top' alt='$product_title'>
            </div>
            <div class="col-md-6">
            <img src='image/mango2.jpg' class='card-img-top' alt='$product_title'>
            </div>
        </div>
    </div>  
    -------------->
